...
$dsn = "pgsql:host=$host;port=5433;dbname=$db;user=$username;password=$password";

try{
    // create a PostgreSQL database connection
    $myPDO = new PDO("pgsql:host=$host;port=5433;dbname=$db;user=$username;password=$password");
